...
benchmark_subarray_2d <- function(n, m,times=50) {
  microbenchmark(
    naive_random_2D = one.simu(n,m, "naive_Rcpp"),
    kadane_random_2D = one.simu(n,m, "kadane_Rcpp"),
    naive_sorted_2D = one.simu2(n,m, "naive_Rcpp"),
    kadane_sorted_2D = one.simu2(n,m, "kadane_Rcpp"),
    times = times
  )
}
